...
import matplotlib.pyplot as plt
import seaborn as sns
data=pd.read_csv (r'C:\Users\MAHIMA MANIGANDAN\Desktop\Hack\Dataset.csv')
print (data)
try:
    data = pd.read_csv(r'C:\Users\MAHIMA MANIGANDAN\Desktop\Hack\Dataset.csv')
    data.drop(['Region', 'Date'], axis = 1, inplace = True)
...
def channel_results(reduced_data, outliers, pca_samples):
	...
	channel = pd.DataFrame(full_data['Date'], columns = ['Date'])
	...
	# Set plot title
	ax.set_title("PCA-Reduced Data Labeled by 'Date'\nTransformed Sample Data Circled");
display(data.head())
display(data.info())
